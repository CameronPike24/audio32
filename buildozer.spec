...
source.include_exts = py,png,jpg,kv,atlas,tflite,csv,wav,mp4,aar,jar
...
requirements = python3==3.6,kivy,camera4kivy,gestures4kivy,numpy,tflite-runtime,kivymd,requests,urllib3,chardet,idna,kivy_garden.graph,audiostream,hostpython3==3.9.12
